...
#define GPIOF_PCLK_DIS()		(RCC->AHB1RSTR |= (1 << 5))
#define GPIOG_PCLK_DIS()		(RCC->AHB1RSTR |= (1 << 6))
#define GPIOH_PCLK_DIS()		(RCC->AHB1RSTR |= (1 << 7))
#define GPIOI_PCLK_DIS()		(RCC->AHB1RSTR |= (1 << 8))
